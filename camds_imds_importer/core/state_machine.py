...
ALLOWED_TRANSITIONS: dict[AppState, set[AppState]] = {
    ...
    AppState.DOCUMENT_LOADED: {AppState.PARSING, AppState.NO_DOCUMENT, AppState.CAMDS_AUTHENTICATED},
    AppState.PARSING: {AppState.PARSED, AppState.FAILED},
    AppState.PARSED: {AppState.VALIDATING, AppState.DOCUMENT_LOADED, AppState.CAMDS_AUTHENTICATED},
    AppState.VALIDATING: {AppState.READY, AppState.FAILED},
